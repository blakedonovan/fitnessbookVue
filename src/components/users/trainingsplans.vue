...
this.isBusy = true
  ...
  const response = await axios.get('http://localhost:8000/api/trainingList/'+this.memberID);
  this.isBusy = false
...
this.resetTrainingUnitForm()
   ...
   const response = await axios.get('http://localhost:8000/api/trainingUnitsbyListID/'+value);
...
let response = await axios.get('http://localhost:8000/api/getTrainingCatSelection/'+value);
...
axios.post('http://localhost:8000/api/addPlan/', trainingPlan)
                 .then((res) => {
                      console.log(res)
...
axios.post('http://localhost:8000/api/removeTrainingPlan/'+RtrainingPlan)
                 .then(() => {
...
console.table(arr)
var addUnitPlanUrl= 'http://localhost:8000/api/addTrainingUnit/';
...
var editUnitPlanUrl= 'http://localhost:8000/api/updateTrainingUnit/'+edit+'?reps='+reps+'&weight='+weight;
...
try {
 ...
 await axios.post('http://localhost:8000/api/removeTrainingUnit/'+remove)
                 .then((res) => {
                      console.log(res)
